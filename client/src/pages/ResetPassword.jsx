      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 to-blue-50 px-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
          <div className="text-center">
            ...
            <Link
              to="/admin"
              className="inline-flex items-center justify-center w-full px-4 py-2 border border-transparent rounded-lg text-sm font-medium text-white bg-primary hover:bg-primary-dark"
            >
              Go to Login
            </Link>
          </div>
